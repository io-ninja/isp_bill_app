                            ...
                            <form data-plugin="parsley" data-option="{}" id="form" validate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kel" name="kel" maxlength="100" required autocomplete="off" placeholder="Tentukan nama kelurahan">
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        coreEvents.placeholder = 'Cari Kelurahan';
